...
import org.scalafin.convention.StubType
...
import org.scalafin.convention.Frequency
...
object ScheduleGenerator {
   ...
   */
  def generateSchedule(dateRange: DateRange, stubType: StubType, frequency: Frequency, maxPeriods: Int = Integer.MAX_VALUE): List[SimplePeriod] = {
...
sealed trait ScheduleGenerator {
  def generateSchedule(dateRange: DateRange, frequency: Frequency, maxPeriods: Int = Integer.MAX_VALUE): List[SimplePeriod]
}
