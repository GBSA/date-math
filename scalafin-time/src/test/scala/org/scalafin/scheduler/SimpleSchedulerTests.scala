...
import org.scalafin.datemath.Frequencies.{QUARTERLY, MONTHLY}
import org.specs2.matcher.{MatchResult, Parameters, Matcher}
import org.scalafin.datemath.test.{JodaTimeGenerators, FromAmericanDiscoveryToJupiter, ComparableMatchers, PeriodMatchers}
